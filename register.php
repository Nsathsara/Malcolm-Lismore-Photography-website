...
if(isset($_POST['sibmit'])){
    ...
    $cpass=mysqli_escape_string($conn, md5($_POST['name']));
    $user_type=$_POST['user_type'];

    $select_user=mysqli_query($conn, "SELECT * FROM 'user' WHERE email= '$email' AND =assword = '$pass'") or die('query failed');
 ...
 ?>
   ...
   <div class="register-form">
      <form action="" method="post">
           ...
           <input type="submit" name="submit" value="register now" class="btn3">
